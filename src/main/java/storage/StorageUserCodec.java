...
public class StorageUserCodec implements Codec {
    @Override
    public Object decode(BsonReader bsonReader, DecoderContext decoderContext) {
        return Database.getGson().fromJson(new DocumentCodec().decode(bsonReader, decoderContext).toJson(), StorageUser.class);
    }
